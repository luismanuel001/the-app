...
gulp.task('hexo:install', () => {
    return gulp.src([`${paths.package.template}/${paths.package.appName}/${paths.package.app}/${paths.hexo.root}/package.json`, `${paths.package.template}/${paths.package.appName}/${paths.package.app}/${paths.hexo.root}/bower.json`])
        .pipe(install());
});
