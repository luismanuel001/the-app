...
.directive('mailMerge', function () {
  return {
    ...
    controller:['$scope','formlyConfig','$http','$compile','$interpolate','mergeService','$modal', '$log',function($scope,formlyConfig,$http,$compile,$interpolate,mergeService,$modal, $log){
      $scope.popup = {
        opened: false
      };
